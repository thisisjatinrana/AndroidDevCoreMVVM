...
public class ActionBar extends RelativeLayout {
    ...
    private void setView() {
        ...
        tvCenter.setId(CommonUtil.getInstance().generateViewId());
        ...
        ivLeft.setId(CommonUtil.getInstance().generateViewId());
        ...
        ivRight.setId(CommonUtil.getInstance().generateViewId());
